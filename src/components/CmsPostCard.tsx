...
export default function CmsPostCard({ data }: Props) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-2 shadow hover:shadow-md transition-all">
              ...
              >
                ...
                >
                  <Icon
                    path={mdiChevronDown}
                    color=""
                    className="h-7 fill-gray-500 hover:fill-blue-600 transition-all"
                  />
                </button>
              </div>
            </th>
        ...
        {isOpen && (
          <tbody>
            ...
            <tr>
              ...
              <td>{data.tags?.length ? data.tags.join(', ') : 'No tags'}</td>
            </tr>
            <tr>
